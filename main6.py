...
for step in range(240):
    ...
    # Apply force to move the cube and maximize loss
    force = [best_action[0].item(), best_action[1].item(), 0.0]  # Force in x, y directions only
    p.applyExternalForce(cube_id, -1, force, [0, 0, 0], p.WORLD_FRAME)
    p.applyExternalForce(sphere_id, -1, [-force[0], -force[1], 0.0], [0, 0, 0], p.WORLD_FRAME)
